...
export function ApiSidebar() {
  ...
  return (
    <div className="plasmo-h-full plasmo-flex plasmo-flex-col plasmo-bg-gray-50">
      {/* 顶部标题栏 */}
      <div className="plasmo-flex-none plasmo-px-4 plasmo-py-3 plasmo-bg-white plasmo-border-b plasmo-border-gray-200 plasmo-flex plasmo-justify-between plasmo-items-center">
        <h2 className="plasmo-text-base plasmo-font-medium plasmo-text-gray-900">
          API 监听器
        </h2>
        <span className="plasmo-text-xs plasmo-text-gray-500 plasmo-bg-gray-100 plasmo-px-2 plasmo-py-0.5 plasmo-rounded">
          {requests.length} 个请求
        </span>
      </div>

      {/* 搜索框 */}
      <div className="plasmo-flex-none plasmo-px-4 plasmo-py-3 plasmo-bg-white plasmo-border-b plasmo-border-gray-200">
